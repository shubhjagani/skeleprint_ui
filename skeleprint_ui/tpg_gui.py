...
class Tool_Path_Generator:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=lambda: tpg_gui_support.tpg(tpg_gui_support.axial_length.get(), tpg_gui_support.filament_width_og.get(), tpg_gui_support.printbed_diameter.get(), tpg_gui_support.final_diameter.get(), tpg_gui_support.helix_angle.get(), tpg_gui_support.smear_factor.get()))
        ...
        self.Label8.configure(text='''G Code file will be saved in parent directory as:
"timestamp_skeleprint_gcode.gcode"''')
        ...
        self.Message2 = Message(self.Labelframe1)
        self.Message2.place(relx=0.03, rely=0.3, relheight=0.37, relwidth=0.94)
        self.Message2.configure(anchor=N)
        self.Message2.configure(background="#e6e6e6")
        self.Message2.configure(font=font9)
        self.Message2.configure(foreground="#000000")
        self.Message2.configure(highlightbackground="#e6e6e6")
        self.Message2.configure(highlightcolor="black")
        self.Message2.configure(text='''Tip:
...
default = 100% (ie. layer height = filament width)''')
        ...
        self.Message1.place(relx=0.05, rely=0.35, relheight=0.6, relwidth=0.9)
        ...
        self.Message1.configure(text='''Tip: 
The angle you define represents the angle between side a and b
|--------------|
|   //       //|
|  //     a // | b
| //       //  |
