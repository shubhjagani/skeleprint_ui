...
#define defaults_h
  ...
  #define DEFAULT_Y_STEPS_PER_MM 110.7692308 // [200 steps/rev * 72/26 (gear ratio) * 2 microsteps] / 10 mm/rev
  ...
  #define DEFAULT_Y_MAX_TRAVEL 2000.0// mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 200.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK ((1<<Y_AXIS)|(1<<Z_AXIS)) // 6
